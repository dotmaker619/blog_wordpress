...
<?php 
    ...
    <div class="col-md-8 pr-4 pr-md-5">
        ...
        <h2 class="spanborder h4 text-capitalize"><span><?php the_archive_title() ?></span></h2> 
        </div>
    ...
    <h4 class="spanborder"><span class="border-0"><?php _e( 'Popular', 'mundana' ); ?> in <div class="text-capitalize d-inline">"<?php the_archive_title() ?>"</div> </span></h4>
    <?php } ?>
    <ol class="list-featured">
        ...
        <li class="loved-item mb-4">
            ...
            echo '<a class="text-muted text-capitalize" href="' . esc_url( get_tag_link( $categories[0]->term_id ) ) . '">' . esc_html( $categories[0]->name ) . '</a>';
            } ?>
            <?php if ($disabledatecard == 0) { ?> · <?php echo get_the_date('M j',$loved->ID);?><?php } ?>
